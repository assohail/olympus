...
export const dai = new StableBond({ //, DAI
  name: "dai",
  displayName: "DAI",
  bondToken: "DAI",
  payoutToken: "OHM",
...
export const frax = new StableBond({//, Frax
  name: "frax",
  displayName: "FRAX",
  bondToken: "FRAX",
  payoutToken: "OHM",
...
// export const lusd = new StableBond({//, LUSD 
//   name: "lusd",
//   displayName: "LUSD",
//   bondToken: "LUSD",
//   payoutToken: "OHM",
...
// export const eth = new CustomBond({//, WETH9
//   name: "eth",
//   displayName: "wETH",
//   lpUrl: "",
...
// export const cvx = new CustomBond({//CVX, 
//   name: "cvx",
//   displayName: "CVX",
//   lpUrl: "",
//   bondType: BondType.StableAsset,
...
export const ohm_dai = new LPBond({ //OlympusBondDepository, UniswapV2Pair
  name: "ohm_dai_lp",
...
// export const ohm_lusd = new LPBond({//OlympusBondDepository, UniswapV2Pair
//   name: "ohm_lusd_lp",
...
// export const ohm_weth = new CustomBond({//, UniswapV2Pair
//   name: "ohm_weth_lp",
